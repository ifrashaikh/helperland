...
<c:set var="id" value="<%= u_id.getUserId() %>" scope="session" ></c:set>
      ...
      <div class="offcanvas offcanvas-end" id="navbarText" aria-labelledby="offcanvasExampleLabel" tabindex="-1">
        <div class="offcanvas-body navbar_list">
          <div class="nav-item navbar_book rounded-pill">
            <a class="nav-link text-light" href="bookService"  id="bookNow">Book now</a>
          </div>
          ...
          <c:if test="${sessionScope.id>0 }">
         <div class="dropdown">
          <button class="btn  dropdown-toggle  rounded-pill" type="button" id="dropdownMenu2" data-bs-toggle="dropdown" aria-expanded="false">
   <img src="<c:url value="/resources/images/forma-1-1@2x.png" ></c:url>" alt="" >
     
             </button>
  <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
    <li><button class="dropdown-item" type="button"> Welcome</button></li>
    <li><button class="dropdown-item" type="button">Name</button></li>
    <hr>
     <li><button class="dropdown-item" type="button"><a href="logout" >Logout</a></button></li>
    <li><button class="dropdown-item" type="button">My settings</button></li>
  </ul>
</div>
</c:if>
        </div>
  ...
  <div class="container-fluid whyus d-flex flex-column align-items-center justify-content-center position-relative"
    ...
    <div class="row whyus_row justify-content-center h-100 w-100 position-relative">
      ...
      <div class="col whyus_col text-center position-relative col-lg-4 mb-3 mb-lg-0">
        <img src="<c:url value="/resources/images/group-23.png"></c:url>" alt="" height="319.5" width="319.5">
        <div class="whyus_content d-flex flex-column justify-content-between position-relative">
    ...
    <div class="container-fluid feedback">
      ...
      <div class="card-group d-flex justify-content-center">
        <div class="card feedback_card">
          ...
          <div class="card-body">
            <div class="card_head d-flex align-items-center">
              <img src="<c:url value="/resources/images/group-31.png"></c:url>" alt="" height="70" width="70">
        ...
        <div class="card feedback_card">
          ...
          <div class="card-body">
            <div class="card_head d-flex align-items-center">
              <img src="<c:url value="/resources/images/group-32.png"></c:url>" alt="" height="70" width="70">
              <div class="card_head_name">
        ...
        <div class="card feedback_card">
          ...
          <div class="card-body">
            <div class="card_head d-flex align-items-center">
              <img src="<c:url value="/resources/images/group-33.png"></c:url>" alt="" height="70" width="70">
              <div class="card_head_name">
...
<div class="logInPopUp">
      ...
      <div class="modal fade" id="logInModal" aria-hidden="true" aria-labelledby="logInModalLabel" tabindex="-1">
          <div class="modal-dialog modal-dialog-centered vertical-align-center modal-md">
              ...
              <a href="forgotPasswordModal" class="forgotPasswordRedirect" data-bs-target="#forgotPasswordModal"
