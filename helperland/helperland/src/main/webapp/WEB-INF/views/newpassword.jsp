...
<body>
    <form action="savepassword" onsubmit="return validate()" method="post" style="margin-left: auto;margin-right: auto;
    width: fit-content;margin-top: 50px;">
        ...
        <input type="text" placeholder="Password"
         name="password" id="password" style="margin-top: 5px;width: 250px;height: 36px;display: block;font-size: 18px;">
         
        <label for="conf_password" style="display: block;font-size: 20px;font-family: 'Roboto',sans-serif;
        font-weight: bold;margin-top: 10px;">Confirm Password</label>
        
        <input type="text" placeholder="Confirm Password" required name="conf_password" id="conf_password" 
        style="margin-top: 5px;width: 250px;height: 36px;display: block;font-size: 18px;">
